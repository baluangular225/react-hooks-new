...
const Usestatepratice6 = () =>{
 ...
 const handleEdit = async (id, name, email, phone, website, address) =>{
    setEditId(id);
    setName(name);
    setEmail(email);
    setPhone(phone);
    ...
    await fetch(`https://jsonplaceholder.typicode.com/users/${id}`,{
        ...
        body: JSON.stringify({id, name, email, phone, website, address:{city}})
    })
    .then(response=>{
        if(!response.ok){
    ...
    return(
        <div>
               <div className="container">
                   <h4 className="mt-4 mb-4" style={{color:'#0070ad'}}>Usestatepratice6 Component</h4>
                   ...
                   <div className="mb-3 mt-3 shadow p-3">
                        ...
                        <input type="text" className="form-control mb-2" name="city" value={city} onChange={(e) => setCity(e.target.value)} placeholder="City" />
                    ...
                    <div className="row">
                        {myData.map((eachData)=>{
                            const {id, name, email, phone, website, address} = eachData;
                            return(
                                <div key={id} className="col-4 col-xs-12">
                                    <div className="shadow p-3 mt-3 mb-3">
                                        ...
                                        <div class="d-grid gap-0 d-md-flex justify-content-md-end">
                                          ...
                                          <button class="btn btn-primary rounded-0" onClick={()=> handleEdit(id, name, email, phone, website, address)}>Edit</button>
                                        </div>
                                    </div>
                                </div>
                            )
...
export default Usestatepratice6;